...
const courriers = [
  { id: 1, numero: '1202-25/2024', date: '2024-12-24 15:03:00', objet: 'Réponse de Demande d\'ouverture de Master en Génie Energ...', destine: 'ENSA- UCD', signe: 'SAHABI MOHAMED', traite: 'secrétaire général', fichier: 'Voir', actions: 'Détails' },
  ];
...
const Depart = () => {
  ...
  return (
    <>
    <Navbar1 />
    <div className="container w-full max-w-7xl mx-auto mt-8 px-4">
  {/* Titre et bouton */}
      ...
      <tbody>
        {courriers.map((courrier) => (
          <tr key={courrier.id} className="hover:bg-gray-100">
            <td className="py-1 px-2 border text-sm whitespace-nowrap">{courrier.numero}</td>
            <td className="py-1 px-2 border text-sm whitespace-nowrap">{formatDate(courrier.date)}</td>
